...
<% } %>
        <div class="-idgbstp">
            ...
            <header id="standard" role="banner">
                <button type="button" class="mobile-nav-btn visible-xs">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon icon-hamburger-nav"></span>
                </button>
                
                <a href="/" title="Ideagen.com"><img src="/easysiteweb/easysite/styledata/ideagen_master/img/logos/ideagen-logo-full-colour.svg" alt="Ideagen PLC" class="site-logo" /></a>
